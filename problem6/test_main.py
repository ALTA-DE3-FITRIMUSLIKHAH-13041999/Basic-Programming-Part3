...
class TestFullPrima(unittest.TestCase):
    ...
    def test_non_prime_numbers(self):
        self.assertEqual(full_prima(11), True, "Expected False for non-prime number (11)")
        self.assertEqual(full_prima(13), True, "Expected False for non-prime number (13)")
        self.assertEqual(full_prima(29), True, "Expected False for non-prime number (29)")
        self.assertEqual(full_prima(41), True, "Expected False for non-prime number (41)")
        self.assertEqual(full_prima(43), True, "Expected False for non-prime number (43)")
    ...
    def test_one(self):
        self.assertEqual(full_prima(1), True, "Expected False for one (1)")
